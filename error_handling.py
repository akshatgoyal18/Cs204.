...
def error_handling():
    WORDS = ['add', 'and', 'or', 'sll', 'slt', 'sra', 'srl', 'sub', 'xor', 'mul', 'div', 'rem','addi', 'andi', 'ori', 'lb', 'ld', 'lh', 'lw', 'jalr' ,'beq', 'bne', 'bge', 'blt' , 'sb', 'sw', 'sd', 'sh', 'auipc', 'lui' ,'jal']
    
    Words1=['add', 'and', 'or', 'sll', 'slt', 'sra', 'srl', 'sub', 'xor', 'mul', 'div', 'rem']
    Words2=['beq', 'bne', 'bge', 'blt']
    BracWords = ['sb', 'sw', 'sd', 'sh','lb', 'ld', 'lh', 'lw', 'jalr']
